...
namespace System.IO.Pipelines.Samples.Http
{
    public partial class HttpConnection<TContext>
    {
        ...
        public ReadOnlySequence<byte> HttpVersion => _parser.HttpVersion;
        public ReadOnlySequence<byte> Path => _parser.Path;
        public ReadOnlySequence<byte> Method => _parser.Method;
