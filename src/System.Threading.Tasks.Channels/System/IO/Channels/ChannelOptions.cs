...
namespace System.IO.Channels
{
    ...
    /// <summary>Provides options that control the behavior of <see cref="UnboundedChannel{T}{T}"/> instances.</summary>
    public sealed class UnboundedChannelOptions : ChannelOptions
    {
    }

    /// <summary>Provides options that control the behavior of <see cref="UnbufferedChannel{T}{T}{T}"/> instances.</summary>
