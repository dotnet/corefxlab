...
{
    internal class JsonPropertyInfoDecimalNullable : JsonPropertyInfo<decimal?>, IJsonConverterInternal<decimal?>
    {
        public JsonPropertyInfoDecimalNullable(Type classType, Type propertyType, PropertyInfo propertyInfo, JsonConverterSettings settings) :
