...
{
    internal class JsonPropertyInfoSingleNullable : JsonPropertyInfo<float?>, IJsonConverterInternal<float?>
    {
        public JsonPropertyInfoSingleNullable(Type classType, Type propertyType, PropertyInfo propertyInfo, JsonConverterSettings settings) :
