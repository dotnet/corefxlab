...
{
    internal class JsonPropertyInfoByte : JsonPropertyInfo<byte>, IJsonConverterInternal<byte>
    {
        public JsonPropertyInfoByte(Type classType, Type propertyType, PropertyInfo propertyInfo, JsonConverterSettings settings) :
