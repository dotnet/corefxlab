...
{
    internal class JsonPropertyInfoUInt16Nullable : JsonPropertyInfo<ushort?>, IJsonConverterInternal<ushort?>
    {
        public JsonPropertyInfoUInt16Nullable(Type classType, Type propertyType, PropertyInfo propertyInfo, JsonConverterSettings settings) :
