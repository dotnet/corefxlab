...
{
    internal class JsonPropertyInfoUInt32Nullable : JsonPropertyInfo<uint?>, IJsonConverterInternal<uint?>
    {
        public JsonPropertyInfoUInt32Nullable(Type classType, Type propertyType, PropertyInfo propertyInfo, JsonConverterSettings settings) :
