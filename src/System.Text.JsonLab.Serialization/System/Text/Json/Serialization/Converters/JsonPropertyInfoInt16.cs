...
{
    internal class JsonPropertyInfoInt16 : JsonPropertyInfo<short>, IJsonConverterInternal<short>
    {
        public JsonPropertyInfoInt16(Type classType, Type propertyType, PropertyInfo propertyInfo, JsonConverterSettings settings) :
