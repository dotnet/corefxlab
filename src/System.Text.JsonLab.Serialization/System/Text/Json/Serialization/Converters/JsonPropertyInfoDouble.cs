...
{
    internal class JsonPropertyInfoDouble : JsonPropertyInfo<double>, IJsonConverterInternal<double>
    {
        public JsonPropertyInfoDouble(Type classType, Type propertyType, PropertyInfo propertyInfo, JsonConverterSettings settings) :
