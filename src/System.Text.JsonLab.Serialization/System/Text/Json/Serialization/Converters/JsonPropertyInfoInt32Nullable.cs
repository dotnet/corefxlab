...
{
    internal class JsonPropertyInfoInt32Nullable : JsonPropertyInfo<int?>, IJsonConverterInternal<int?>
    {
        public JsonPropertyInfoInt32Nullable(Type classType, Type propertyType, PropertyInfo propertyInfo, JsonConverterSettings settings) :
