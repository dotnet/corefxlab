...
{
    /// <summary>
    /// Enumerates all the system types that TypeLoaders may need to fish out of the core assembly. Note that the enum values are often cast to "int"
    /// and used as indices into a table so the enum values should be left contiguous.
    /// </summary>
