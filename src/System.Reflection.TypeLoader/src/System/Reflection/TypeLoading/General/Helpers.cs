...
namespace System.Reflection.TypeLoading
{
    internal static class Helpers
    {
        ...
        {
            // @TODO - This is not the best way to compute the PKT as AssemblyName throws if the PK isn't a valid PK blob.
            // That's not something we should block a metadata inspection tool for so we should compute the PKT ourselves as soon as
            // we can convince the CoreFx analyzers to let us use SHA1.
