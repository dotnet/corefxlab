...
/// <summary>
/// Note: This is taken directly from the current implementation of DispatchProxy and DispatchProxyGenerator, found here: https://github.com/dotnet/corefx/tree/master/src/System.Reflection.DispatchProxy/src/System/Reflection
/// We need to make some minor changes to DispatchProxy to allow for the Dynamic Assembly to have access modifier `AssemblyBuildAccess.RunAndCollect`. See issue here: https://github.com/dotnet/corefx/issues/38898
/// </summary>
namespace ALCProxy.Communication
{
    ...
    internal static class DispatchProxyGenerator
    {
        ...
        private class ProxyAssembly
        {
            ...
            {
                _ab = AssemblyBuilder.DefineDynamicAssembly(new AssemblyName("ProxyBuilder"), AssemblyBuilderAccess.RunAndCollect);
