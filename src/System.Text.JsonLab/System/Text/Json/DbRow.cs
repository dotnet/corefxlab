...
namespace System.Text.JsonLab
{
    ...
    internal struct DbRow
    {
        ...
        public JsonTokenType JsonType => (JsonTokenType)((_union & 0x70000000) >> 28); // type of JSON construct (e.g. Object, Array, Number)
        ...
        public DbRow(JsonTokenType jsonType, int location, int sizeOrLength = UnknownSize, int numberOfRows = 1)
        {
        ...
        internal DbRow(JsonTokenType jsonType, int location, bool hasChildren, int sizeOrLength, int numberOfRows)
        {
            Debug.Assert(jsonType >= JsonTokenType.None && jsonType <= JsonTokenType.Comment);
            Debug.Assert(location >= 0);
            Debug.Assert(sizeOrLength >= UnknownSize);
        ...
        public bool IsSimpleValue => JsonType > JsonTokenType.EndArray;
    }
}
