...
namespace System.Text.JsonLab
{
    ...
    {
        public Utf8JsonReader2(in ReadOnlySequence<byte> data)
        {
            _containerMask = 0;
            Depth = 0;
            _inObject = false;
        ...
        public Utf8JsonReader2(in ReadOnlySequence<byte> data, bool isFinalBlock, JsonReaderState state = default)
        {
            if (!state.IsDefault)
            {
