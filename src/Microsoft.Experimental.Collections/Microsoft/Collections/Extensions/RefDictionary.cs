...
namespace Microsoft.Experimental.Collections
{
    ...
    public class RefDictionaryOld<TKey, TValue> : IReadOnlyCollection<KeyValuePair<TKey, TValue>> where TKey : IEquatable<TKey> // almost IReadOnlyDictionary<TKey, TValue>
    {
        private int[] _buckets;
        private Entry[] _entries;
        ...
        public RefDictionaryOld(int capacity = 16)
        {
            _buckets = new int[capacity];
            _entries = new Entry[capacity];
        }
        ...
        public struct Enumerator : IEnumerator<KeyValuePair<TKey, TValue>>
        {
            private readonly RefDictionaryOld<TKey, TValue> _dictionary;
            private int _index;

            internal Enumerator(RefDictionaryOld<TKey, TValue> dictionary)
            {
                _dictionary = dictionary;
                _index = 0;
                Current = default;
