...
namespace System.IO.Pipelines
{
    public static class DefaultReadableBufferExtensions
    {
        ...
        public static unsafe bool TrySliceTo(this ReadOnlySequence<byte> buffer, byte b1, byte b2, out ReadOnlySequence<byte> slice, out SequencePosition cursor)
        {
        ...
        /// <param name="cursor">A <see cref="SequencePosition"/> that points to the second byte</param>
        /// <returns>True if the byte sequence was found, false if not found</returns>
        public static bool TrySliceTo(this ReadOnlySequence<byte> buffer, Span<byte> span, out ReadOnlySequence<byte> slice, out SequencePosition cursor)
        {
            var result = false;
        ...
        public static bool StartsWith(this ReadOnlySequence<byte> buffer, Span<byte> value)
        {
        ...
        public static bool EqualsTo(this ReadOnlySequence<byte> buffer, Span<byte> value)
        {
