...
{
    public struct ILModuleDefinition
    {
        ...
        internal static ILModuleDefinition Create(ModuleDefinition definition, ref Readers readers)
        {
            ILModuleDefinition module = new ILModuleDefinition();
