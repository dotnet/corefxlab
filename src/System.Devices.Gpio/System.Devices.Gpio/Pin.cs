...
namespace System.Devices.Gpio
{
    ...
    public class Pin : IDisposable
    {
        ...
        public EventKind DetectedEvents
        {
            get => Controller.Driver.GetEventsToDetect(BcmNumber);
            set => Controller.Driver.SetEventsToDetect(BcmNumber, value);
        }
        ...
        public bool WaitForEvent(TimeSpan timeout) => Controller.Driver.WaitForEvent(BcmNumber, timeout);
