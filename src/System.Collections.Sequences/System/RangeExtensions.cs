...
namespace System
{
    public static class RangeExtensions
    {
        ...
        {
            return range.IsEmpty(null);
        }

        public static bool IsEmpty<T>(this Range<T> range, IEqualityComparer<T> comparer)
        {
            if (comparer == null)
                comparer = EqualityComparer<T>.Default;

            return comparer.Equals(range.From, range.To);
        }
        ...
        {
            return range.IsNormalized(null);
        }
        ...
        public static bool IsNormalized<T>(this Range<T> range, IComparer<T> comparer)
        {
            ...
            return comparer.Compare(range.To, range.From) >= 0;
        }

        public static Range<T> Normalize<T>(this Range<T> range)
        {
            return range.Normalize(null);
        }
        ...
        public static Range<T> Normalize<T>(this Range<T> range, IComparer<T> comparer)
        {
            ...
            return (comparer.Compare(range.To, range.From) >= 0) ? range : new Range<T>(range.To, range.From);
        }
        ...
        {
            return range.Contains(value, null);
        }
        ...
        {
            return range.Intersects(other, null);
        }
        ...
        {
            return range.Intersect(other, null);
        }
