...
namespace System.Text.Primitives.Tests
{
    public partial class PrimitiveParserTests
    {
        ...
        public unsafe void BooleanPositiveTests(string text, int length, bool expectedValue, int expectedConsumed)
        {
            ...
            result = PrimitiveParser.TryParseBoolean(byteSpan, out actualValue, out actualConsumed, TextEncoder.InvariantUtf8);
            ...
            result = PrimitiveParser.TryParseBoolean(utf16ByteSpan, out actualValue, out actualConsumed, TextEncoder.InvariantUtf16);
            Assert.True(result);
            Assert.Equal(expectedValue, actualValue);
