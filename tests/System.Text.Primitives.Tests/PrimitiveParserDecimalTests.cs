...
namespace System.Text.Primitives.Tests
{
    public partial class PrimitiveParserTests
    {
        ...
        public unsafe void DecimalPositiveTests(string text, int length, decimal expectedValue, int expectedConsumed)
        {
            ...
            result = PrimitiveParser.TryParseDecimal(byteSpan, out actualValue, out actualConsumed, TextEncoder.InvariantUtf8);
            ...
            result = PrimitiveParser.TryParseDecimal(utf16ByteSpan, out actualValue, out actualConsumed, TextEncoder.InvariantUtf16);
            Assert.True(result);
            Assert.Equal(expectedValue, actualValue);
