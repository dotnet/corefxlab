...
namespace System.Text.Primitives.Tests
{
    public partial class PrimitiveParserTests
    {
        ...
        public unsafe void ParseInt32Dec(string text, bool expectSuccess, int expectedValue, int expectedConsumed)
        {
            ...
            result = PrimitiveParser.InvariantUtf8.TryParseInt32_OLD(utf8Span, out parsedValue, out consumed);
            Assert.Equal(expectSuccess, result);
            Assert.Equal(expectedValue, parsedValue);
            Assert.Equal(expectedConsumed, consumed);
        }
        ...
        [Fact]
        private static void ParseInt32DecVariableLength()
        {
        ...
        [Fact]
        public unsafe void ParseInt32Dec2()
        {
            ...
            unsafe
            {
                ...
                try
                {
                    ...
                    bool result = PrimitiveParser.InvariantUtf8.TryParseInt32_OLD(span, out int parsedValue, out int consumed);
                    Assert.Equal(true, result);
                    Assert.Equal(11, parsedValue);
                    Assert.Equal(TwoGiB, consumed);
                }
                finally
                {
